...
mensaje2 = "Hola Mundo"
numero = "12345"
decimeales= "182345.555"


#print(mensaje.isdigit)
#print(numero.isdigit())
#print(decimeales.isdigit())

#print(mensaje.isnumeric)
#print(numero.isnumeric())
#print(decimeales.isnumeric())

#print(mensaje.isdecimal)
#print(numero.isdecimal())
#print(decimeales.isdecimal())

#mensaje3=mensaje2.replace("Hola","hello")

#print(mensaje3)

#mensaje = "adios mundo curel"
#print(mensaje.split0(""))


nombre = "Norman*Alexis*Bu*Gomez"
print(nombre.split("*"))
print(nombre.count("*"))